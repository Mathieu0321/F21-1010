...
<h1>Lecture 6 - Lists / Dictionaries</h1>
...
<p>A dictionary is an association between a &ldquo;key&rdquo; value and a set of data
that is efficient for looking thins up by the key.</p>

<p>let&rsquo;s do an &ldquo;age&rdquo; one&hellip;</p>
...
Print out a sorted list of the words in the file with the number of occurrences of each word.  Sort from the most frequent word to the least.</p>

<h3>Requirements Broken Down</h3>

<ol>
<li>Prompt for a file name.</li>
<li>Read in a file of text.<br /></li>
<li>Split the file up into words.</li>
<li>Remove any punctuation and convert each word to lower case.</li>
<li>Count how many times each word occurs.</li>
<li>Print out a sorted list

<ul>
<li>Print out a sorted list of the words in the file with the number of occurrences of each word.</li>
<li>Sort from the most frequent word to the least.</li>
</ul></li>
</ol>
...
<p>Copyright &copy; University of Wyoming, 2021.</p>
